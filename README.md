...
> [!NOTE]
> This is an **unofficial** LaTeX template for the West University of
> Timișoara. It is fairly complete and working well, but any feature requests
...
presentations, this theme will probably take some liberties with it, but the
general vibe should be the same.
